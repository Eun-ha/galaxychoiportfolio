...
export const works: Work[] = [
  ...
  },
  {
    ...
    desc: "tailwind CSS를 활용한 반응형 디자인 적용 및 Javascript를 활용하여 브라우저 스크롤에 반응하는 UI를 구현했습니다. 기획 및 디자인팀과 Figma로 협업을 진행하고, Git과 Jira를 통해 프로젝트를 관리하였으며, SEO 향상을 위한 Metadata 및 소셜미디어 opengraph 이미지를 적용하였습니다.",
  ...
  },
  {
    ...
    desc: "모바일과 PC 환경에서 공유 기능을 분기하여 개발하였습니다. 모바일에서는 window.navigator.share API, PC에서는 navigator.clipboard.writeText로 URL 복사 기능을 구현하였습니다. 단축 URL API 호출 및 디바이스별 테스트를 통해 안정적인 서비스를 제공하였습니다.",
  ...
  },
  {
    ...
    desc: "사내 운영툴을 사용한 데이터 스키마 생성 및 데이터 연동 및 통합 배너 기능 개발을 했습니다. JavaScript 클래스를 사용한 객체 생성 방식으로 공통 배너 기능 개발하였고, Date() 함수를 활용하여 예약 설정 기능을 개발하였고 Jest를 활용한 컴포넌트 테스트 및 사용 가이드 문서 작성 하였습니다.",
  ...
  },
  {
    ...
    desc: "시멘틱 마크업 및 반응형 디자인을 적용하였고, 스크롤 반응형 Navigation UI 동작을 위한 JavaScript 작업 및 Slick 플러그인 활용한 슬라이더 UI 개발을 하였습니다.",
  ...
  },
  {
    ...
    desc: "react, next.js, redux-toolkit 스킬을 연구하는 사이드 프로젝트로 CRUD 기능을 설계 및 구현하였습니다.",
